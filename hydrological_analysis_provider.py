...
import os
from .hydrological_analysis_algorithm import HydrologicalAnalysisStreams


class HydrologyProvider(QgsProcessingProvider):
    ...
    def name(self):
        ...
        """
        return self.tr('Hydrology Analysis')
